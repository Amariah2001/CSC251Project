...
public class Policy {
    ...
    private int policyHeight; // used to get policyholder's height in inches
    ...
    private double BASE_FEE = 600; // base fee for the insurance policy
    ...
    private double ADD_FEE75 = 75; // used if the policyholder is > 50 years old
    private double ADD_FEE100 = 100; // used when the policyholder is a smoker
    ...
    public void setPolicyHeight(int polyHeight) {
        policyHeight = polyHeight;
    }

    public int getPolicyHeight() {
        return policyHeight;
    }
    ...
    public double getBMI(double policyWeight, int policyHeight) { // method used to calculate and return the BMI of the policyholder
    ...
    public double getPrice() {
        ...
        else if (policyStatus == "smoker") {
            totalPrice = BASE_FEE + ADD_FEE100;
        }
        else if (policyBMI > 35) {
